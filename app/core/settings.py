...
DB_MANAGED_SETTING_FIELDS: tuple[SettingFieldDefinition, ...] = (
    ...
    SettingFieldDefinition(
        ...
        group="Tuning",
        description="Minimum shelf score for Suggested For You. Titles must clear this threshold to appear, and candidates at or above it are eligible for the AI blend.",
        input_type="number",
        min_value="0",
        max_value="1",
        step="0.01",
